...
## ☁️ Облака слов по темам

Каждая тема визуализирована в виде облака слов, где размер слова отражает его важность в теме:

![Все темы](https://github.com/user-attachments/assets/8dbb52d3-4f9a-498a-9edf-f39eef14df13)
![Динамика тем](https://github.com/user-attachments/assets/a7aeea52-4304-4971-a58b-81770a727bee)

> 💡 **Как сгенерировать:** Облака слов и графики создаются автоматически при выполнении `model.py` с помощью библиотеки `wordcloud`. Изображения сохраняются в папку `data/LDA_analys/`.
